...
* **[Registrasi Akun](file:///c:/laragon/www/praktikum/docs/uml/activity-registrasi-akun.puml)**
  - *Aktor:* Pengguna Umum
  - *Deskripsi:* Alur pendaftaran pengguna baru, pengisian detail profile, enkripsi password, dan penyimpanan ke tabel `users`.
* **[Login & Logout](file:///c:/laragon/www/praktikum/docs/uml/activity-login-logout.puml)**
...
* **[Kelola Profil & Alamat](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-profil.puml)**
  - *Aktor:* Semua Pengguna
...
* **[Cari & Jelajahi Produk](file:///c:/laragon/www/praktikum/docs/uml/activity-cari-produk.puml)**
  - *Aktor:* Pembeli Umum
  - *Deskripsi:* Pencarian katalog produk dengan query teks, filtering kategori/harga, dan visualisasi detail item.
* **[Kelola Keranjang Belanja](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-keranjang.puml)**
  - *Aktor:* Pembeli Umum
  - *Deskripsi:* Manipulasi item belanja (tambah, edit quantity, hapus) dengan validasi real-time ketersediaan stok produk.
* **[Checkout Pesanan (Split Order)](file:///c:/laragon/www/praktikum/docs/uml/activity-checkout.puml)**
  - *Aktor:* Pembeli Umum
...
* **[Unggah Bukti Pembayaran](file:///c:/laragon/www/praktikum/docs/uml/activity-upload-pembayaran.puml)**
  - *Aktor:* Pembeli Umum
...
* **[Lacak Status Pengiriman](file:///c:/laragon/www/praktikum/docs/uml/activity-lacak-pengiriman.puml)**
  - *Aktor:* Pembeli Umum
  - *Deskripsi:* Menelusuri log pergerakan kurir pengiriman menggunakan nomor resi pesanan.
* **[Konfirmasi Terima Barang](file:///c:/laragon/www/praktikum/docs/uml/activity-konfirmasi-terima.puml)**
  - *Aktor:* Pembeli Umum
...
* **[Beri Ulasan & Rating Produk](file:///c:/laragon/www/praktikum/docs/uml/activity-ulasan.puml)**
  - *Aktor:* Pembeli Umum
...
* **[Cetak Invoice Pembelian (PDF)](file:///c:/laragon/www/praktikum/docs/uml/activity-cetak-invoice.puml)**
...
* **[Pendaftaran & Pengaturan Toko](file:///c:/laragon/www/praktikum/docs/uml/activity-pendaftaran-toko.puml)**
  - *Aktor:* Merchant
...
* **[Kelola Katalog Produk](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-produk.puml)**
  - *Aktor:* Merchant
...
* **[Kelola Stok & Log Mutasi (Stock Ledger)](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-stok.puml)**
  - *Aktor:* Merchant
...
* **[Kelola Status Pesanan Masuk](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-pesanan-masuk.puml)**
  - *Aktor:* Merchant
...
* **[Lihat Dashboard Finansial & Grafik](file:///c:/laragon/www/praktikum/docs/uml/activity-dashboard-merchant.puml)**
  - *Aktor:* Merchant
...
* **[Cetak Laporan Penjualan Berkala (PDF)](file:///c:/laragon/www/praktikum/docs/uml/activity-cetak-laporan-penjualan.puml)**
  - *Aktor:* Merchant
...
* **[Cetak Laporan Stok Kritis (PDF)](file:///c:/laragon/www/praktikum/docs/uml/activity-cetak-laporan-stok-kritis.puml)**
  - *Aktor:* Merchant
  - *Deskripsi:* Menghasilkan daftar produk dengan kuantitas stok di bawah minimum limit dalam format file PDF.
* **[Ekspor Rekap Penjualan Akuntansi (Excel)](file:///c:/laragon/www/praktikum/docs/uml/activity-ekspor-rekap-penjualan.puml)**
  - *Aktor:* Merchant
...
* **[Ekspor Kartu Mutasi Stok (Excel)](file:///c:/laragon/www/praktikum/docs/uml/activity-ekspor-kartu-mutasi.puml)**
  - *Aktor:* Merchant
  - *Deskripsi:* Ekspor kronologis mutasi keluar masuk stok per produk ke lembar kerja Excel (Audit Trail).
* **[Ekspor Laporan Ulasan (Excel)](file:///c:/laragon/www/praktikum/docs/uml/activity-ekspor-laporan-ulasan.puml)**
  - *Aktor:* Merchant
  - *Deskripsi:* Mengekspor daftar ulasan, rating, dan komentar pembeli dalam spreadsheet Excel.

### 5. Modul Administrator Platform
* **[Moderasi & Verifikasi Toko](file:///c:/laragon/www/praktikum/docs/uml/activity-verifikasi-toko.puml)**
...
* **[Kelola Kategori Global](file:///c:/laragon/www/praktikum/docs/uml/activity-kelola-kategori-global.puml)**
  - *Aktor:* Admin Platform
...
* **[Lihat Dashboard Performa Platform](file:///c:/laragon/www/praktikum/docs/uml/activity-dashboard-admin.puml)**
  - *Aktor:* Admin Platform
...
* **[Cetak Laporan Komisi & Performa (PDF)](file:///c:/laragon/www/praktikum/docs/uml/activity-cetak-laporan-komisi.puml)**
  - *Aktor:* Admin Platform
...
### 1. Modul Autentikasi & Manajemen Pengguna
* **[Registrasi Akun](file:///c:/laragon/www/praktikum/docs/uml/sequence-registrasi-akun.puml)**
...
* **[Login & Logout](file:///c:/laragon/www/praktikum/docs/uml/sequence-login-logout.puml)**
...
* **[Kelola Profil & Alamat](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-profil.puml)**
...
### 2. Modul Pembeli (Customer)
* **[Cari & Jelajahi Produk](file:///c:/laragon/www/praktikum/docs/uml/sequence-cari-produk.puml)**
...
* **[Kelola Keranjang Belanja](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-keranjang.puml)**
...
* **[Checkout Pesanan (Split Order)](file:///c:/laragon/www/praktikum/docs/uml/sequence-checkout.puml)**
...
* **[Unggah Bukti Pembayaran](file:///c:/laragon/www/praktikum/docs/uml/sequence-upload-pembayaran.puml)**
...
* **[Lacak Status Pengiriman](file:///c:/laragon/www/praktikum/docs/uml/sequence-lacak-pengiriman.puml)**
...
* **[Konfirmasi Terima Barang](file:///c:/laragon/www/praktikum/docs/uml/sequence-konfirmasi-terima.puml)**
...
* **[Beri Ulasan & Rating Produk](file:///c:/laragon/www/praktikum/docs/uml/sequence-ulasan.puml)**
...
* **[Cetak Invoice Pembelian (PDF)](file:///c:/laragon/www/praktikum/docs/uml/sequence-cetak-invoice.puml)**
...
### 3. Modul Merchant (Penjual)
* **[Pendaftaran & Pengaturan Toko](file:///c:/laragon/www/praktikum/docs/uml/sequence-pendaftaran-toko.puml)**
...
* **[Kelola Katalog Produk](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-produk.puml)**
...
* **[Kelola Stok & Log Mutasi (Stock Ledger)](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-stok.puml)**
...
* **[Kelola Status Pesanan Masuk](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-pesanan-masuk.puml)**
...
### 4. Modul Analisis & Pelaporan (Merchant Dashboard)
* **[Lihat Dashboard Finansial & Grafik](file:///c:/laragon/www/praktikum/docs/uml/sequence-dashboard-merchant.puml)**
...
* **[Cetak Laporan Penjualan Berkala (PDF)](file:///c:/laragon/www/praktikum/docs/uml/sequence-cetak-laporan-penjualan.puml)**
...
* **[Cetak Laporan Stok Kritis (PDF)](file:///c:/laragon/www/praktikum/docs/uml/sequence-cetak-laporan-stok-kritis.puml)**
...
* **[Ekspor Rekap Penjualan Akuntansi (Excel)](file:///c:/laragon/www/praktikum/docs/uml/sequence-ekspor-rekap-penjualan.puml)**
...
* **[Ekspor Kartu Mutasi Stok (Excel)](file:///c:/laragon/www/praktikum/docs/uml/sequence-ekspor-kartu-mutasi.puml)**
...
* **[Ekspor Laporan Ulasan (Excel)](file:///c:/laragon/www/praktikum/docs/uml/sequence-ekspor-laporan-ulasan.puml)**
...
### 5. Modul Administrator Platform
* **[Moderasi & Verifikasi Toko](file:///c:/laragon/www/praktikum/docs/uml/sequence-verifikasi-toko.puml)**
...
* **[Kelola Kategori Global](file:///c:/laragon/www/praktikum/docs/uml/sequence-kelola-kategori-global.puml)**
...
* **[Lihat Dashboard Performa Platform](file:///c:/laragon/www/praktikum/docs/uml/sequence-dashboard-admin.puml)**
...
* **[Cetak Laporan Komisi & Performa (PDF)](file:///c:/laragon/www/praktikum/docs/uml/sequence-cetak-laporan-komisi.puml)**
...
* **[Class Diagram Lengkap](file:///c:/laragon/www/praktikum/docs/uml/class-diagram.puml)**
