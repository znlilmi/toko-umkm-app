<x-app-layout>
    <div class="py-6 max-w-xl mx-auto space-y-6">
        ...
        <div class="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm">
            <h1 class="text-xl font-bold text-slate-800 mb-2">Tambah Kategori Baru</h1>
            <p class="text-xs text-slate-400 mb-6">Mendaftarkan kategori produk baru yang berlaku secara global.</p>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="parent_id" class="block text-sm font-semibold text-slate-700 mb-2">Kategori Induk (Pilih jika sub-kategori)</label>
